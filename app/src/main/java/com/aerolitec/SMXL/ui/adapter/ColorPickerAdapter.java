 ...
 */
public class ColorPickerAdapter extends ArrayAdapter<ColorPicker>{
        ...
        public void addHeader(int title) {
            add(new ColorPicker(title, -1, true,-1));
        }

        public void addItem(int title, int icon,int id) {
            add(new ColorPicker(title, icon, false,id));
        }

        public void addItem(ColorPicker itemModel) {
            add(itemModel);
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ColorPicker item = getItem(position);
                    ...
                    if(item != null && viewHolder != null){
                        ...
                        if (viewHolder.squareHolder != null) {
                            if (item.colorSquare != 0) {
                                ...
                                viewHolder.squareHolder.setBackgroundColor(Constants.ColorUtils.parseWhiteColor());
                            }
                        }
                    }
