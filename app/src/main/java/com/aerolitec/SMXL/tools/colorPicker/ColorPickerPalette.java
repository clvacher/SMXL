...
public class ColorPickerPalette extends TableLayout {
     ...
     */
    public void drawPalette(int[] colors, ArrayList<Integer> selectedColors) {
        if (colors == null) {
            return;
        }
        ...
        for (int color : colors) {
            ...
            View colorSwatch = createColorSwatch(color, selectedColors);
            setSwatchDescription(rowNumber, tableElements, rowElements, selectedColors.contains(color),
                    colorSwatch);
     ...
     */
    private ColorPickerSwatch createColorSwatch(int color, ArrayList<Integer> selectedColors) {
        ColorPickerSwatch view = new ColorPickerSwatch(getContext(), color,
                selectedColors.contains(color), mOnColorSelectedListener);
        TableRow.LayoutParams params = new TableRow.LayoutParams(mSwatchLength, mSwatchLength);
        params.setMargins(mMarginSize, mMarginSize, mMarginSize, mMarginSize);
        view.setLayoutParams(params);
        return view;
